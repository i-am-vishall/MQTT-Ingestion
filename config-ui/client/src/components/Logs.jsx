        ...
        <div className="p-4" style={{ height: 'calc(100vh - 100px)' }}>
            ...
            <div className="flex flex-wrap gap-4 mb-4 items-center bg-gray-100 p-3 rounded">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded text-white font-bold ${isLive ? 'bg-red-500 hover:bg-red-600' : 'bg-green-500 hover:bg-green-600'}`}
                >
            ...
            >
                ...
                {filteredLogs.map((log, i) => (
                    <div key={i} className="whitespace-pre-wrap break-all border-b border-gray-800 py-1 hover:bg-gray-800">
                        {log.system ? (
                            <div style={{ color: "cyan", fontWeight: 'bold' }}>⚙ {log.msg}</div>
                        ) : log.timestamp ? (
                            <div>
