-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.1.0 to 2.6.1
-- generated by tools/build-extension-update-files
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -



\echo Use "ALTER extension pgrouting update to '2.6.1'" to load this file. \quit


-------------------------------------
-- remove functions no longer in the 2.6.1 extension
-------------------------------------
...
-- 2.6.1: {edges_sql, start_vid,   end_vid, k,       has_rcost}
...
-- 2.6.1: {edges_sql, directed, has_rcost}
...
-- 2.6.1: {sql,    source,    targets, directed, has_rcost} 
...
-- 2.6.1:  {version,tag,hash,branch,boost}
...
-- 2.6.1:  {edges_sql,  start_vid,    end_vid, directed, has_rcost,        restrictions_sql}
...
-- 2.6.1:  {sql, eids, pcts, directed, has_rcost,       turn_restrict_sql}
...
-- pgr_bddijkstra
-- 2.1.0: {      sql, source_vid, target_vid, directed, has_reverse_cost}   
-- 2.6.1: {edges_sql,  start_vid,    end_vid, directed, has_rcost}
...
-- 2.6.1:  {edges_sql, start_vid, end_vid, k, directed, heap_paths, seq, path_id, path_seq, node,edge, cost, agg_cost}
...
-- 2.6.1: {edges_sql,source,distance,directed,has_rcost}
...
-- 2.6.1: {edges_sql,start_vid,distance,directed,seq,node,edge,cost,agg_cost}
...
-- 2.6.1: {edges_sql,start_vids,distance,directed,equicost,seq,from_v,node,edge,cost,agg_cost}
