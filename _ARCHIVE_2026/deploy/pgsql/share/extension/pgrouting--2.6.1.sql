...
$BODY$
    SELECT '2.6.1'::varchar AS version,
        'v2.6.1'::varchar AS tag,
        '1360698'::varchar AS hash,
        'release/2.6'::varchar AS branch,
...
CREATE OR REPLACE FUNCTION _trsp(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.6', 'turn_restriction'
LANGUAGE 'c' VOLATILE;
...
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.6', 'lineGraphFull'
