...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2020-11-21 01:58:46
...
BEGIN
 ...
 RAISE NOTICE 'newly registered SEQUENCE topology.topology_id_seq';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered SEQUENCE topology.topology_id_seq';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
