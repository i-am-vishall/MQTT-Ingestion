...
module.exports = {
    ...
    service: {
        ...
        workers: parseInt(process.env.WORKER_THREADS || '8'),
        ...
        shockAbsorberMode: ['true', '1', 'on'].includes(String(process.env.SHOCK_ABSORBER_MODE || 'false').toLowerCase()),
    },
    redis: {
    ...
    stream: {
        ...
        maxLen: parseInt(process.env.REDIS_STREAM_MAXLEN || '3000000'),
        consumerGroup: process.env.REDIS_CONSUMER_GROUP || 'workers',
    },
    // Backpressure / Circuit Breaker thresholds
    backpressure: {
        yellowThreshold: parseInt(process.env.BACKPRESSURE_YELLOW || '1000000'),
        redThreshold: parseInt(process.env.BACKPRESSURE_RED || '2500000'),
    },
